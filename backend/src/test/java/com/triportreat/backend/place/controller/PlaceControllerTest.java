...
class PlaceControllerTest {
    ...
    void searchPlaceListByCondition_fail() throws Exception {
        ...
        List<PlaceByRegionIdDto> places = List.of(
                PlaceByRegionIdDto.builder().placeId(1L).placeName("테스트1").contentTypeId(1L).build(),
                PlaceByRegionIdDto.builder().placeId(2L).placeName("테스트2").contentTypeId(2L).build(),
                PlaceByRegionIdDto.builder().placeId(3L).placeName("테스트3").contentTypeId(3L).build()
        );
    ...
    void searchPlaceListByCondition_success() throws Exception {
        ...
        mockMvc.perform(get("/places")
                ...
                .andExpect(jsonPath("$.data[0].placeName").value("테스트1"))
